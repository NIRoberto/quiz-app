  ...
  return (
    <div>
      ...
      <section className="bg-dark-yellow text-center py-16">
        <h1 className="text-4xl font-semibold text- mb-4 text-yellow-500">Game Library</h1>
        <p className="text-gray-700 text-lg">Explore a collection of interactive quizzes and expand your knowledge.</p>
      </section>
      ...
      <section className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {gameData.map((game, index) => (
            <div key={index} className="bg- p-6 flex flex-col  justify-between gap-4 rounded-md shadow-md">
              <img src={'quiz.webp'} loading="lazy" alt={game.title} className="mb-4 text-gray-700 rounded-lg" />
