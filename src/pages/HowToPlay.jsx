  ...
  return (
    <div>
      ...
      <section className="bg-dark-yellow text-center py-16">
        <h1 className="text-4xl font-semibold text-yellow-500  mb-4">How to Play</h1>
        <p className="text-lg text-gray-700">A step-by-step guide to enhance your learning experience.</p>
      </section>
      ...
      <section className="container mx-auto py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <h2 className="text-3xl font-semibold text-yellow-500 mb-4">Getting Started</h2>
            <p className="leading-relaxed text-gray-700">Playing on QUIZLet is easy and enjoyable. Follow these simple steps to get started:</p>
          ...
          <div>
            ...
            <img src="/quiz.webp" alt="How to Play" className="rounded-lg shadow-lg" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-dark-gray  py-12">
        <div className="container mx-auto text-ce">
          <h2 className="text-3xl text-yellow-500 font-semibold mb-4">Tips for Success</h2>
          <p className="leading-relaxed text-gray-700">To make the most out of your QUIZLet experience, consider these tips:</p>
          <ul className="list-disc pl-6 mt-4">
