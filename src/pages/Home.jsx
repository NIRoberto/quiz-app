...
const Home = () => {
  const featuredQuizzes = [
    ...
    },
    {
      ...
      image: "./quiz.webp",
      description:
        "Discover the world and its diverse landscapes in this quiz.",
      link: "/quiz/geography",
    },
    {
      ...
      image: "./quiz.webp",
      description:
        "Explore classic literature and famous authors in this quiz.",
  ...
  return (
    <>
      <section className="bg-dark-yellow text-center py-16">
        ...
        <p className=" mb-8">
          Explore our interactive quizzes and enhance your learning experience.
        </p>
        <div className="space-x-4">
          <Link to="/about" className="btn capitalize btn-primary">
            Learn More
          </Link>
          <Link to="/game-library" className="btn capitalize btn-secondary">
            Start Exploring
          </Link>
        </div>
      </section>
      ...
      <section className="bg-dark-yellow text-center py-16">
        ...
        <p className=" mb-8">
          Join QuizQuest now and gain access to a world of knowledge!
        </p>
